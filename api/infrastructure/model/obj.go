...
func (om *ObjMerge) Merge(objs []Obj, otherObjs ...Obj) []Obj {
	newObjs := make([]Obj, 0, len(objs)+len(otherObjs))
	newObjs = om.insertObjs(om.insertObjs(newObjs, objs...), otherObjs...)
	return newObjs
}

func (om *ObjMerge) insertObjs(objs []Obj, otherObjs ...Obj) []Obj {
