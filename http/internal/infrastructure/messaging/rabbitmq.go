...
import (
	...
	"github.com/hilthontt/visper/internal/infrastructure/retry"
	"github.com/hilthontt/visper/internal/infrastructure/tracing"
	amqp "github.com/rabbitmq/amqp091-go"
)

const (
	VisperExchange     = "visper"
...
func (r *RabbitMQ) PublishMessage(ctx context.Context, routingKey string, message contracts.AmqpMessage) error {
	...
	return tracing.TracedPublisher(ctx, VisperExchange, routingKey, msg, r.publish)
}
