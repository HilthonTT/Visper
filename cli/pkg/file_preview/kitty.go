...
func isKittyCapable() bool {
	...
	// Additional detection for terminals that might not be detected be rasterm
	if !isCapable {
...
func (p *ImagePreviewer) renderWithKittyUsingTermCap(
	img image.Image,
	path string,
	originalWidth,
	originalHeight,
	...
	// Get terminal cellsize from ImagePreviewer's terminal capabilities
