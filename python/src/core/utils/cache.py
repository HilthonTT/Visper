...
from ..exceptions.cache_exceptions import CacheIndentificationInferenceError, InvalidRequestError, MissingClientError
...
def _infer_resource_id(kwargs: dict[str, Any], resource_id_type: type | tuple[type,...]) -> int | str:
    ...
    if resource_id is None:
        raise CacheIndentificationInferenceError
    return resource_id
